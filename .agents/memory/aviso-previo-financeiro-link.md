...
- **Duas vias de pagamento exclusivas**: baixa manual do RH ("Dar Baixa") OU envio ao Financeiro — nunca as duas. `enviarParaFinanceiro` rejeita se `baixaRescisaoData`/`dataBaixa` já existem; qualquer novo caminho de baixa deve manter essa exclusão.
