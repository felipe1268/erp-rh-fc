...
**Ago/2026:** a cadeia de blocos ColFix parou de logar/executar após ~Rev.4441 no dev (blocos finais, ex. Rev.4910 epi_estoque_ajustes, nunca rodaram e o marker colfix_version não é gravado). Novo bloco ColFix ≠ garantia de execução: sempre verificar via SELECT to_regclass no Neon e, se preciso, criar a tabela manualmente (o SQL é idempotente e o Neon é compartilhado dev/prod).
