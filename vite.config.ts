...
// inside the Replit/Manus iframe (development preview). When running as a
// production build (command === 'build'), the script blocks React from mounting
// causing a blank white screen on the deployed URL. Always exclude it on build.
