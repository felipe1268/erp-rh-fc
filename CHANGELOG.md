...
- **TOTAL — coluna Retenção mostra apenas o crédito final**: na linha TOTAL da Previsão de Medição, a coluna "− Ret. %" antes mostrava `−R$ X / +R$ X` (retido durante a obra / liberado no fim), o que se anulava visualmente. Como esse valor é, na prática, um **crédito a receber** (o cliente devolve no fim da obra), agora mostramos só o **valor positivo final** em verde (ex.: `+R$ 23.184,07`) com tooltip "Crédito a receber: total retido durante a obra que será liberado após a conclusão".
