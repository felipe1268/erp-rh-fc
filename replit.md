...
- **Rev. 3771** — **FINANCEIRO · DUPLICATA "MÃO DE OBRA TERCEIRIZADA - OBRA" × "/ SUBEMPREITEIRO" ELIMINADA: 1.147 LANÇAMENTOS UNIFICADOS EM NOME CANÔNICO (conta_id=23). MAPA + BRIDGE + AUTOIMPORT CORRIGIDOS. ZERO SCHEMA/ALTER/DROP/DELETE.** Detalhe: `shared/changelog.ts`.
