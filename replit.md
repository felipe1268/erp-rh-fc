...
- **Rev. 1789**: **Portal Cliente · KPIs Curva S — Previsto azul, Realizado verde**. Pedido direto do user. Antes Previsto era amber/dourado (convenção MS Project) e Realizado azul-marinho — conflitava com leitura natural Lean. Trocados em `PortalPlanejamentoCliente.tsx` L2210-2212 (3 linhas): ícone+accent+valueClassName de cada card. Desvio mantém vermelho/verde por sinal (Rev. 1788). Curvas internas (gráfico) seguem inalteradas (padrão ANSI EVMS).
