...
- **Rev. 3791** — **FINANCEIRO · CONCILIAÇÃO BANCÁRIA · PAINEL DE SELEÇÃO DE CONTA GANHA DOIS BOTÕES DISTINTOS: "LIMPAR ESTA CONTA" (APARECE QUANDO UMA CONTA ESTÁ SELECIONADA — LIMPA SÓ ELA) E "LIMPAR TODAS AS CONTAS" (TODAS DO PERÍODO). ANTES HAVIA APENAS O BOTÃO DE TODAS. 100% FRONTEND · ZERO BACKEND/SCHEMA/ALTER/DROP/DELETE.** Detalhe: `shared/changelog.ts`.
