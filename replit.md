...
- **Rev. 1656**: **Avanço Físico — top card acompanha a semana selecionada na aba Avanço Semanal**. Restaura Rev. 1649 sem perder a Opção A do Rev. 1655. Quando o usuário troca a semana (ex.: 3ª Semana — 18/05 a 24/05), a barra superior segue junto: Previsto E Realizado usam `refStr = semanaVisualizacao + 7d` (mesma janela do card "PREVISTO (SEMANA)"). Top card e card grande convergem (ex.: 5,56% na Semana 3). Sem semana selecionada, mantém lock no cutoff oficial (Rev. 1655 preservado). EV volta a usar `avancosMapSemana` (filtrado por av.semana <= semVis). `PlanejamentoDetalhe.tsx` ~L490-555.
