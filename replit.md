...
- **Rev. 3781** — **FINANCEIRO · DASHBOARD CONCILIAÇÃO · RANKING "DESPESAS POR CATEGORIA" AGORA LISTA TODAS AS CATEGORIAS SEM LIMITE (ANTES CORTAVA EM 8/12/15). SCROLL INTERNO 600px. BACKEND READ-ONLY · ZERO SCHEMA/ALTER/DROP/DELETE.** Detalhe: `shared/changelog.ts`.
