...
- **Rev. 4419** — **CORREÇÕES C5 E S1 (AJUSTES_ERP_17072026).** C5: fix `estoqueParticipante` no fallback de `criarOrdemDeCotacao`. S1: `assertCentralWrite` relaxado p/ ≥1 obra. ZERO DELETE · ZERO ALTER destrutivo.
