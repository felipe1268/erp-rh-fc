...
- **Rev. 4052** — **`/planos`: AZUL MAIS ESCURO EM TODA A LANDING + MASCOTE "JULINHO" VIROU UM ROBÔ ANIMADO E INTERATIVO.** Usuário achou o azul da Rev. 4051 claro demais e pediu robô no lugar do mascote humano. Paleta aprofundada (blue-600→900, blue-500→800, blue-400→700, blue-300→600, sky-*→indigo-*), mantendo tints claros (blue-50/100/200) como fundo suave; array `MODULES` intocado. Nova imagem `client/src/assets/julinho_robot.png` (robô branco/prateado, colete amarelo, visor azul, tablet holográfico); no hero ele flutua continuamente, tem glow pulsante, e é clicável (troca a fala do balão entre 4 mensagens via `AnimatePresence`); versão decorativa no CTA final também flutua. ZERO DELETE · ZERO ALTER destrutivo.
