...
- **Rev. 3801** — **FINANCEIRO · CONCILIAÇÃO · REMOÇÃO DE LANÇAMENTO DUPLICADO (BUG IMPORTAÇÃO): FERRI LORIGGIO R$5.769,60/14-01-2026 EXISTIA EM CAIXA JF (CORRETO) E CAIXA FC APARECIDA (ERRÔNEO). ENTRY 885854 DELETADA; EXTRATO 13062 DELETADO. ZERO SCHEMA/ALTER/DROP/DELETE DE ESTRUTURA.** Detalhe: `shared/changelog.ts`.
