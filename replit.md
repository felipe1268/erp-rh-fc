...
- **Rev. 3801** — **FINANCEIRO · CONCILIAÇÃO · REMOÇÃO DE LANÇAMENTO DUPLICADO (BUG IMPORTAÇÃO): FERRI LORIGGIO R$5.769,60/14-01-2026 EXISTIA EM CAIXA JF (CORRETO) E CAIXA FC APARECIDA (ERRÔNEO). ENTRY 885854 DELETADA; EXTRATO 13062 DESCONCILIADO. ZERO SCHEMA/ALTER/DROP/DELETE DE ESTRUTURA.** Detalhe: `shared/changelog.ts`.
...
- **Rev. 3796** — **FINANCEIRO · DRE · PADRONIZAÇÃO DE conta_nome: 79 ENTRIES COM conta_nome DIVERGENTE DO NOME OFICIAL DA CONTA UNIFICADOS VIA UPDATE. ELIMINA DUPLICATAS NO DRILL-DOWN. ZERO SCHEMA/ALTER/DROP/DELETE.** Detalhe: `shared/changelog.ts`.

- **Rev. 3795** — **SISTEMA · PERMISSÕES · FIX SISTÊMICO DE PROPAGAÇÃO DE ROTAS: groupCanAccessRoute RETORNAVA false EM 3 PONTOS; FALLBACK POR PREFIXO URL + LIBERA POR PADRÃO. 100% FRONTEND · ZERO BACKEND/SCHEMA/ALTER/DROP/DELETE.** Detalhe: `shared/changelog.ts`.
