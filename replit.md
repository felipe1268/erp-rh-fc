...
- **Rev. 3779** — **FINANCEIRO · BUSCA NO DIÁLOGO "VINCULAR CHEQUE DEVOLVIDO A PIX/TED" CORRIGIDA: TEXTO DIGITADO AGORA RODA 2ª QUERY SQL COM ILIKE (MERGE + DEDUP), EVITANDO QUE LINHAS SEJAM CORTADAS PELO LIMIT 300 DA ORDENAÇÃO POR VALOR. BACKEND READ-ONLY · ZERO SCHEMA/ALTER/DROP/DELETE.** Detalhe: `shared/changelog.ts`.
