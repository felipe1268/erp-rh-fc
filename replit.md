...
- **Rev. 2275** — **FEAT · "AVANÇO FÍSICO POR GRUPO" separa pais e filhos até as FOLHAS finais com barras horizontais por nível.** Pedido user (23/05/2026, VITRA): "precisa separar por pais e filhos de forma que possamos analisar cada ativiade por % e grafico em barras horizontal". Diagnóstico (`PlanejamentoDetalhe.tsx::buildSubgrupos` L13501): estrutura `grupos[].etapas[].children[]` já era recursiva desde Rev. 1887 e `renderRow` (Rev. 1945) já tinha chevron + barras + indentação, MAS `buildSubgrupos` filtrava `a.isGrupo` → árvore parava no último grupo (01.01 MOBILIZAÇÃO) sem mostrar folhas (01.01.01 Saúde 45,93 % / 01.01.02 ART 22,96 %). Fix L13514-13544: filhos diretos = descendentes com `nivel === parent+1` (grupos + folhas), ordenados por `ordem` MSP; branch grupo recursa, branch folha vira nó terminal `{previsto: prevInd(e), realizado: realMap[e.id], children: []}`. Resultado VITRA: detalhamento expandido percorre 01.01 → 01.01.01 / 01.01.02, idem 01.02/01.03/01.07/01.08; "Expandir tudo" desce até folhas. **R-001/R-007/R-010:** N/A (client-only useMemo).
