...
const menuSectionsRHDP: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Wallet, label: "Outras Receitas", path: "/folha-proventos" },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: MessageCircle, label: "Conversa WhatsApp", path: "/whatsapp-rh" },
...
const menuSectionsSST: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: FileSignature, label: "Ficha de EPI", path: "/epis/ficha" },
...
const menuSectionsFinanceiro: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Banknote, label: "Controle de Cheques Emitidos",  path: "/financeiro/cheques" },
      { icon: Banknote, label: "Controle de Cheques Recebidos", path: "/financeiro/cheques-recebidos" },
...
const ICON_MAP: Record<string, any> = {
  ...
  "Conversa WhatsApp": MessageCircle,
  ...
  const effectiveSections = useMemo(() => {
    ...
    if (!permIsAdminMaster) {
      ...
      const DASHBOARD_ROUTE_ALIAS: Record<string, string> = {
        ...
        '/folha-proventos': '/folha-pagamento',
      };
