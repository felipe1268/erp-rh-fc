...
<style>
@page{size:A4;margin:25mm 15mm 14mm 15mm}
@page :first{margin:14mm 15mm}
body{font-family:'Helvetica','Arial','Liberation Sans',sans-serif;font-size:11pt;line-height:1.55;color:#1a1a1a}
.fc-doc{max-width:760px;margin:0 auto;background:#fff;padding:32px 1.5cm;box-sizing:border-box}
.fc-doc p{margin:0 0 10px 0;text-align:justify}
.fc-doc strong{font-weight:700;color:#1a1a1a}
@media print{
  body{background:#fff}
  .fc-doc{max-width:none;padding:8px 0;box-shadow:none;border:none}
