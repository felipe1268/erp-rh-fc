...
const MODULES_LIST = [
  ...
  { key: "epis", label: "EPIs" },
  { key: "epi_entregas", label: "Entregas de EPI" },
  { key: "acidentes", label: "Acidentes" },
  { key: "riscos", label: "Riscos" },
  { key: "auditorias", label: "Auditorias" },
  { key: "desvios", label: "Desvios" },
  { key: "planos_acao", label: "Planos de Ação (5W2H)" },
  { key: "dds", label: "DDS" },
  { key: "cipa_eleicoes", label: "Eleições CIPA" },
  { key: "cipa_membros", label: "Membros CIPA" },
  ...
  { key: "documentos_treinamento", label: "Documentos de Treinamento" },
