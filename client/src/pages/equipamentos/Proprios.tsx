        ...
        >
          ...
          >
            ...
            <div className="p-4 space-y-3 flex-1 overflow-y-auto min-h-0">
              ...
              {/* Rev. 4512 — Valor de aquisição sempre visível no formulário principal */}
              <div className="border-t pt-3">
                ...
                <input
                  ...
                  placeholder="Ex: 4.724,60"
                  className="w-full sm:w-48 px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
                <p className="text-[10.5px] text-slate-400 mt-1">
                  Use vírgula como separador decimal. Ex: 1.500,00
                </p>
              </div>
