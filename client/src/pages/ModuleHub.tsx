...
const MODULES: Module[] = [
  {
    ...
    path: "/painel/rh",
    active: true,
    features: ["Colaboradores", "Folha de Pagamento", "Ponto Eletrônico", "Férias & Aviso Prévio", "Prestadores de Serviço", "Vale Alimentação"],
  },
  {
    id: "sst",
    title: "SST",
  ...
  },
  {
    ...
    icon: DollarSign, accentFrom: "#F59E0B", accentTo: "#D97706", accentGlow: "rgba(245,158,11,0.35)", iconBg: "rgba(245,158,11,0.12)", path: "/financeiro", active: true, features: ["Lançamentos", "Contas a Pagar", "Previsão de Faturamento", "DRE", "Fluxo de Caixa", "Plano de Contas", "Obrigações Fiscais", "Conciliação Bancária"],
  },
  {
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  {user?.role === 'admin_master' && (
                    <>
                      ...
                      <DropdownMenuItem onClick={() => navigate("/admin/saas")} className="cursor-pointer">
                        <ShoppingCart className="mr-2 h-4 w-4" /> Gestão de Vendas (SaaS)
                      </DropdownMenuItem>
                    </>
                  )}
                  <DropdownMenuSeparator />
