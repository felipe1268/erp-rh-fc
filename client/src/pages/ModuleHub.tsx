                ...
                {sortedActiveModules.map((mod, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`group relative flex flex-col items-center justify-center text-center rounded-2xl pt-4 pb-3 px-2 cursor-pointer ${mounted ? 'hub-animate-up' : 'opacity-0'} transition-all duration-200 hover:scale-[1.04] select-none`}
                      style={{
                        ...
                        border: isDropTarget
                          ...
                          : `1.5px solid #e8eaf0`,
                        boxShadow: '0 2px 12px -3px rgba(0,0,0,0.10), 0 1px 3px -1px rgba(0,0,0,0.06)',
                      }}
                    >
                      {/* Hover tint */}
                      <div
                        className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                        style={{ background: `linear-gradient(145deg, ${mod.accentFrom}0d, ${mod.accentTo}07)` }}
                      />
                      ...
                      <div
                        ...
                        style={{
                          ...
                          boxShadow: `0 6px 16px -4px ${mod.accentGlow || mod.accentFrom + "60"}`,
                        }}
                      >
                      ...
                      {/* Title */}
                      <p className="text-[11.5px] font-bold leading-tight text-[#1B2A4A] tracking-tight w-full truncate">{mod.title}</p>
