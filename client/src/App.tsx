...
const FinanceiroConciliacaoPainel = lazyWithRetry(() => import("./pages/financeiro/FinanceiroConciliacaoPainel"));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/financeiro/conciliacao/painel" component={() => <RouteGuard component={FinanceiroConciliacaoPainel} route="/financeiro/conciliacao" />} />
