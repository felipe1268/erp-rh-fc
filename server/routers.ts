...
export const appRouter = router({
  ...
  moduleConfig: router({
    list: protectedProcedure.input(z.object({ companyId: z.number(), companyIds: z.array(z.number()).optional(), })).query(async ({ input, ctx }) => {
      ...
      const ALL_MODULES = ["rh", "sst", "juridico", "avaliacao", "terceiros", "parceiros", "orcamento", "planejamento", "medicao", "cadastro", "compras", "almoxarifado", "financeiro", "gestao-documentos"];
