...
const COLUMN_MAP = [
  ...
  { header: "Cargo", field: "cargo", required: false, example: "Pedreiro" },
  { header: "Função*", field: "funcao", required: true, example: "Pedreiro" },
  { header: "Setor*", field: "setor", required: true, example: "Obras" },
  { header: "Código Contábil", field: "codigoContabil", required: false, example: "128" },
  ...
  { header: "Valor Hora", field: "valorHora", required: false, example: "11.36" },
  ...
  { header: "Tipo Chave PIX", field: "tipoChavePix", required: false, example: "CPF" },
  { header: "HE Normal 50%", field: "heNormal50", required: false, example: "Sim" },
  { header: "HE 100%", field: "he100", required: false, example: "Não" },
  { header: "HE Noturna", field: "heNoturna", required: false, example: "Não" },
  { header: "HE Feriado", field: "heFeriado", required: false, example: "Não" },
  { header: "HE Interjornada", field: "heInterjornada", required: false, example: "Não" },
  { header: "Acordo HE", field: "acordoHoraExtra", required: false, example: "" },
...
function generateTemplate(): Buffer {
  ...
  const instrucoes = [
    ...
    ["- HE (Hora Extra): Sim ou Não"],
    ["- Status: Ativo, Ferias, Afastado, Licenca, Desligado, Recluso, Lista_Negra"],
    ["- Estado (UF): Sigla de 2 letras (SP, RJ, MG, etc.)"],
    [""],
    ["CAMPOS ADICIONAIS:"],
    ["- Código Contábil: Código contábil do colaborador (ex: 128)"],
    ["- Cargo: Cargo do colaborador (pode ser diferente da Função)"],
    ["- Valor Hora: Valor da hora de trabalho (ex: 11.36)"],
    ["- Acordo HE: Descrição do acordo de hora extra, se houver"],
    [""],
      ...
      for (const p of parsed) {
        ...
        try {
          ...
          const optionalFields = [
            ...
            "cargo", "funcao", "setor", "codigoContabil", "dataAdmissao", "salarioBase", "valorHora", "horasMensais",
            "tipoContrato", "jornadaTrabalho", "banco", "agencia", "conta", "tipoConta",
            "chavePix", "tipoChavePix", "heNormal50", "he100", "heNoturna", "heFeriado", "heInterjornada", "acordoHoraExtra", "observacoes",
          ];
