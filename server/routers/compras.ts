  ...
  getSolicitacao: protectedProcedure
    ...
    .query(async ({ input, ctx }) => {
      ...
      return {
        ...
        // Rev. 2290 — Locação: devem constar no retorno ou o form de edição os perde.
        isLocacao: sc.isLocacao ?? false,
        locacaoDuracaoDias: sc.locacaoDuracaoDias ?? null,
        locacaoDataInicioPrevista: sc.locacaoDataInicioPrevista ?? null,
        locacaoDataFimPrevista: sc.locacaoDataFimPrevista ?? null,
