...
const convencaoRouter = router({
  ...
  create: protectedProcedure.input(z.object({
    ...
    pisoSalarial: z.coerce.string().optional(),
    percentualReajuste: z.coerce.string().optional(),
    adicionalInsalubridade: z.coerce.string().optional(),
    adicionalPericulosidade: z.coerce.string().optional(),
    horaExtraDiurna: z.coerce.string().optional(),
    horaExtraNoturna: z.coerce.string().optional(),
    horaExtraDomingo: z.coerce.string().optional(),
    adicionalNoturno: z.coerce.string().optional(),
    valeRefeicao: z.coerce.string().optional(),
    valeAlimentacao: z.coerce.string().optional(),
    valeTransporte: z.coerce.string().optional(),
    cestaBasica: z.coerce.string().optional(),
    auxilioFarmacia: z.coerce.string().optional(),
    planoSaude: z.coerce.string().optional(),
    seguroVida: z.coerce.string().optional(),
    outrosBeneficios: z.coerce.string().optional(),
    clausulasEspeciais: z.coerce.string().optional(),
    isMatriz: z.union([z.boolean(), z.number()]).optional(),
