  ...
  funcionarios: router({
    ...
    update: protectedProcedure
      .input(z.object({
        ...
        nr10DocUrl: z.string().nullish(),
        nr10Validade: z.string().nullish(),
        nr33DocUrl: z.string().nullish(),
        nr33Validade: z.string().nullish(),
        nr35DocUrl: z.string().nullish(),
        nr35Validade: z.string().nullish(),
        integracaoDocUrl: z.string().nullish(),
        integracaoClienteDocUrl: z.string().nullish(),
        fichaEpiUrl: z.string().nullish(),
        ordemServicoUrl: z.string().nullish(),
        registroFuncionarioUrl: z.string().nullish(),
