...
export const CHANGELOG: RevisionEntry[] = [
  ...
  },
  {
    ...
    criadoPor: 'Sistema',
    dataPublicacao: '2026-05-11 03:30:00',
  },
  {
    version: 1563,
  ...
  },
  {
    ...
    tipo: 'melhoria',
    modulos: 'Portal do Cliente, Avaliações, NPS, LGPD',
    criadoPor: 'Sistema',
    dataPublicacao: '2026-05-10 21:30:00',
  },
  {
    version: 1550,
  ...
  },
  {
    ...
    modulos: 'Portal do Cliente, Planejamento',
    criadoPor: 'Sistema',
    dataPublicacao: '2026-05-10 14:30:00',
  },
  {
    version: 1534,
    titulo: "Recovery Schedule completo — janela configurável, sugestão automática e data de convergência",
    descricao: "EVOLUÇÃO da Rev. 1533 (PMBOK 7ª/AACE 23R-02): a 'Meta para recuperar' que cobrava TODO o débito numa única semana virou irreal quando o atraso passa de 4-5pp. Agora 3 camadas: (1) SELETOR de janela 1/2/4/6/8/12 semanas (default 4) persistido no banco em planejamento_revisoes.recovery_window_semanas — só engenheiro vê e edita; (2) SUGESTÃO automática de janela mínima viável calculada via histórico: max(realizado_semanal_ult6) − média(baseline_semanal_ult6) = folga de pico; janela_min = ceil(débito ÷ folga). Aparece como chip âmbar '💡 Sugerido: X sem'. Se a capacidade comprovada não supera o baseline, omite (folga≤0); (3) DATA prevista de convergência '📅 Atraso zerado em DD/MM/AAAA' = fim_semana_atual + N×7 dias. Aplicado nos 3 lugares: (a) ProgramacaoSemanal.tsx — seletor + meta diluída + sugestão + convergência + chip auxiliar 'agressiva 1 sem' como teto de referência; coluna 'Recuperação' por atividade agora mostra '+X.Xpp/sem' (gap÷N) em vez de gap inteiro. (b) AvancoSemanal de PlanejamentoDetalhe.tsx — lê janela do mesmo revisaoAtiva.recoveryWindowSemanas (single source of truth); mostra meta diluída + convergência sem seletor (definido em Programação Semanal). (c) Portal do Cliente — AbaAvancoSemanal e AbaProgSemanal recebem recoveryWindowSemanas via portalExterno.ts; cliente vê COMPROMISSO CONGELADO ('Compromisso (4 sem): X%/sem' + data de convergência), sem seletor, sem meta agressiva, sem sugestão. Schema: drizzle/schema.ts ganhou coluna nova; ColFix em server/_core/index.ts garante migração; tRPC ganhou setRecoveryWindow protectedProcedure. PV (baseline) permanece IMUTÁVEL — só muda a estratégia gerencial de cobrança.",
    tipo: 'feature',
    modulos: 'Planejamento, Portal do Cliente',
    criadoPor: 'Sistema',
  ...
  },
  {
    ...
    modulos: 'Planejamento, Portal do Cliente',
    criadoPor: 'Sistema',
    dataPublicacao: '2026-05-09 16:00:00',
  },
  {
    version: 1508,
  ...
  },
  {
    ...
    modulos: 'Planejamento',
    criadoPor: 'Sistema',
    dataPublicacao: '2026-05-09 12:00:00',
  },
  {
    version: 1502,
  ...
  },
  {
    ...
    modulos: 'Planejamento',
    criadoPor: 'Sistema',
    dataPublicacao: '2026-05-09 09:10:00',
  },
  {
    version: 1495,
  ...
  },
  {
    ...
    modulos: "Portal do Cliente, Planejamento",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-09 01:30:00",
  },
  {
    version: 1481,
  ...
  },
  {
    ...
    tipo: "bugfix",
    modulos: "RH & DP, Raio-X do Funcionário",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-08 19:30:00",
  },
  {
    version: 1462,
    titulo: "Portal do Cliente — Hub de Módulos (Planejamento, RH/Documentos, Proj./Doc. Técnicos) + Terceiros no Efetivo",
    descricao: "O Portal do Cliente foi reorganizado no estilo do ModuleHub interno. Após o login, o cliente cai em /portal/cliente/hub e vê 4 cards de módulos (Planejamento da Obra, RH / Controle de Documentos, Proj./Doc. Técnicos e Mensagens & Avaliação). Ao clicar em um módulo, o cliente vê a lista de obras a que ele tem acesso (filtradas por razão social/nome fantasia, igual ao backend antigo) e escolhe a obra para abrir o módulo já filtrado. Foram criadas duas novas telas no portal: (1) RH / Controle de Documentos (/portal/cliente/rh/:obraId) — para cada funcionário CLT alocado na obra mostra ASO vigente/vencido, atestados últimos 12 meses, treinamentos vigentes e advertências, com KPIs no topo (Funcionários, ASO Vigente, ASO Vencido, Sem ASO, Com Atestado, Com Advertência) e tabela detalhada com drill-down por funcionário; (2) Proj./Doc. Técnicos (/portal/cliente/projdoc/:obraId) — lista todos os documentos do GD (gd_documentos) da obra com KPIs (Total / Aprovados / Em Revisão / Em Elaboração / Reprovados), filtro por status e download direto via arquivoUrl. Backend novo: portalExterno.cliente.documentosRhObra e portalExterno.cliente.projDocObra (mesma regra de autorização das outras procs do cliente — token JWT + obra ∈ obras do cliente). EFETIVO DA OBRA: a procedure efetivoObra agora retorna CLT + Terceiros (funcionarios_terceiros alocados na obra, com badge 'Terceiro' e nome da empresa terceira em 'setor'), e a aba Efetivo do portal foi reescrita localmente para mostrar 3 KPIs no topo (Total CLT / Total Terceiros / Total Geral), badge 'CLT'/'Terceiro' por linha e coluna 'Empresa/Setor'. Nova UX: /portal/cliente/hub é a porta de entrada; /portal/cliente/dashboard continua existindo (mensagens & avaliações) acessível pelo card Mensagens & Avaliação.",
    tipo: "feature",
    modulos: "Portal do Cliente",
    criadoPor: "Sistema",
  ...
  },
  {
    ...
    modulos: "Portal do Cliente, Planejamento",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-09 01:15:00",
  },
  {
    version: 1444,
    titulo: "Portal do Cliente — 4 novas abas liberadas: Gantt, REFIS, Caminho Crítico e Efetivo",
    descricao: "Liberadas e implementadas no portal do cliente as abas Gantt, REFIS, Caminho Crítico e Efetivo (antes marcadas como 'em breve'). (1) GANTT: cronograma visual horizontal com cabeçalho de meses, barras coloridas por status (azul=em execução, vermelho=atrasada, verde=concluída), preenchimento interno indicando % realizado, linha 'hoje' destacada — até 80 atividades folha exibidas. (2) REFIS: tabela completa com Nº, Semana, Emissão, % Prev. Acum., % Real. Acum. (verde se ≥ previsto, vermelho se abaixo), SPI, CPI, status (rascunho/emitido/consolidado) — dados puxados de planejamento_refis pelo backend. (3) CAMINHO CRÍTICO: lista de atividades não-concluídas ordenadas por criticidade (atrasadas primeiro, depois pelo maior desvio negativo) com EAP, datas, duração, % previsto vs realizado, desvio colorido, folga em dias (vermelho/âmbar/cinza) e badge de status — limita a 50 itens. (4) EFETIVO: 4 KPIs (Total Direto, Indireto, Central, Geral) + tabela mensal com colunas Direto/Indireto/Central/Total e linha de totais — dados de planejamento_custos_mo agrupados por mês e tipo. Backend cliente.planejamentoObra agora retorna refisLista, caminhoCritico e efetivoMensal calculados server-side. Ícones (CalendarCheck, FileText, GitBranch, HardHat) adicionados ao mapa ABA_ICONS. Demais abas (Crono. Financeiro, Prev. Medição, Diagrama de Rede, Custo RH, BIM 3D) continuam marcadas como 'em breve'.",
    tipo: "feature",
    modulos: "Portal do Cliente, Planejamento",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-09 00:30:00",
  },
  {
    version: 1443,
  ...
  },
  {
    ...
    tipo: "seguranca",
    modulos: "Proj./Doc. Técnicos,Permissões",
    criadoPor: "Sistema",
  ...
  },
  {
    ...
    modulos: "Compras",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-08 19:05:00",
  },
  {
    version: 1422,
  ...
  },
  {
    ...
    tipo: "melhoria",
    modulos: "Dashboards,Parceiros,RaioX,Colaboradores",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-08 14:00:00",
  },
  {
    version: 1412,
    titulo: "Dashboard Parceiros: layout full-width + seletor visual Ano/Mês + Comparativo Mês a Mês (padrão Folha/Cartão de Ponto)",
    descricao: "MELHORIAS: (1) LAYOUT — removida a restrição max-w-7xl e ajustados paddings/grids para que TODAS as informações apareçam corretamente em qualquer largura de tela (mobile, tablet, desktop, ultrawide). KPIs principais agora seguem grid-cols-2 sm:grid-cols-3 lg:grid-cols-6. (2) SELETOR ANO/MÊS VISUAL — substituídos os selects de Ano e Mês por um cartão dedicado: navegação de ano com setas ‹ › e o ano em destaque, legenda à direita (Com lançamento azul, Consolidado verde, Sem dados cinza) e abaixo as 12 pílulas Jan..Dez coloridas conforme a situação do mês (verde = todos lançamentos aprovados; azul = há lançamentos com pendências/rejeitados em aberto; cinza = sem dados). O mês selecionado fica destacado com anel preto. Clicar no mês selecionado volta para 'Todos'. (3) COMPARATIVO MÊS A MÊS — adicionada tabela no padrão dos dashboards Folha de Pagamento e Cartão de Ponto: 12 linhas (Jan a Dez) com Lançamentos, Valor Total, Aprovados, Pendentes (md+), Rejeitados (md+), Pago (lg+) e A Pagar (lg+). Cada métrica mostra Δ% vs o mês anterior com setas verdes/vermelhas (semântica respeitando se subir é bom — aprovados/pago — ou ruim — pendentes/rejeitados/a pagar). Linha de TOTAL no rodapé. Linha do mês atual destacada. Clique em qualquer linha abre o drill-down em tela cheia daquele mês. O comparativo só aparece quando o filtro de mês está em 'Todos' (visão anual).",
    tipo: "melhoria",
    modulos: "Dashboards,Parceiros",
    criadoPor: "Sistema",
  ...
  },
  {
    ...
    modulos: "Terceiros",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-07 18:00:00",
  },
  {
    version: 1386,
    titulo: "Compras — Sistema de Reservas Preventivas + Travamento Cirúrgico (Opção C)",
    descricao: "FEATURE: novas tabelas compras_reservas_saldo e compras_reservas_log + fluxo completo de proteção de saldo. (1) Quando uma cotação fecha com déficit, o sistema cria automaticamente uma reserva preventiva da DI-08 + Economia em Compras (prazo padrão: 7 dias) — visível em Realocações nos novos cards 'Reservado' e na nova aba 'Reservas em Andamento'. (2) A reserva é consumida quando o déficit é coberto via 'debitarDoRisco' ou 'confirmarRealocacaoSobras', e liberada automaticamente quando a cotação/OC é excluída, cancelada ou recusada. (3) Travamento Cirúrgico (Opção C): após 7 dias com reservas pendentes, perfis de Compras (comprador, gerente_compras, diretor_compras etc.) ficam IMPEDIDOS de gerar novas OCs deficitárias — operações saudáveis (sem déficit) seguem livres. admin_master e diretor passam direto. (4) Modelo de responsabilidade COLETIVA: qualquer comprador pode resolver qualquer pendência da empresa. (5) Hierarquia de extensão de prazo: admin_master ilimitado (até 60d), diretor +7d, gerente_compras +3d. (6) Override em lote (estenderPrazoUsuario) — admin_master libera todas reservas pendentes de um usuário de uma vez. (7) SC de Emergência (criarSCEmergencia) sempre liberada com dupla aprovação posterior. (8) Modal de aviso (ReservasAlertModal) aparece para perfis Compras quando há reservas pendentes — banner persistente no topo do módulo Compras. Procedures novas: listarReservasAtivas, verificarTravamentoCompras, estenderPrazoReserva, estenderPrazoUsuario, transferirResponsavelReserva, criarSCEmergencia, listarLogsReserva. getSaldosRealocacaoGeral agora retorna di08Reservado, sobrasReservadas, di08DisponivelReal, sobrasDisponivelReal, totalReservado e totalDisponivelReal.",
    tipo: "feature",
    modulos: "Compras",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-07 16:00:00",
  },
  {
    version: 1385,
  ...
  },
  {
    ...
    modulos: "Orçamento",
    criadoPor: "Agent",
    dataPublicacao: "2026-05-06 18:30:00",
  },
  {
    version: 1294,
  ...
  },
  {
    ...
    modulos: "SST",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-07 02:00:00",
  },
  {
    version: 1369,
  ...
  },
  {
    ...
    modulos: "SST",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-07 00:15:00",
  },
  {
    version: 1366,
  ...
  },
  {
    ...
    modulos: "SST",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-07 06:15:00",
  },
  {
    version: 1380,
  ...
  {
    version: 1656,
    titulo: "Avanço Físico — top card acompanha a semana selecionada na aba Avanço Semanal",
    descricao: "Restaura comportamento Rev. 1649 sem perder a Opção A do Rev. 1655. Agora, quando o usuário troca a semana visualizada na aba Avanço Semanal (ex.: 3ª Semana — 18/05 a 24/05), a barra superior 'Avanço Físico' acompanha junto: tanto Previsto quanto Realizado usam `refStr = semanaVisualizacao + 7d` (mesma janela do card 'PREVISTO (SEMANA)'). Top card e card grande convergem no MESMO valor (ex.: 5,56% na Semana 3). Quando NÃO há semana selecionada (estado inicial / outras abas), a barra continua travada no cutoff oficial — preserva o comportamento da Rev. 1655 (3 displays alinhados em 1,41% no cutoff Qui). EV volta a usar `avancosMapSemana` (filtrado por av.semana <= semVis), garantindo que o Realizado reflita só o que foi medido até a semana visualizada. `PlanejamentoDetalhe.tsx` ~L490-525 (avancoAtual) e ~L540-555 (avancoPrevistoDia); deps `semanaVisualizacao` adicionada nas 2 useMemo.",
    tipo: "melhoria",
    modulos: "Planejamento",
    criadoPor: "Sistema",
    dataPublicacao: "2026-05-11 19:30:00",
  },
  {
    version: 1655,
